...
| Capability | Status | Notes |
|---|---|---|
| Multi-provider AI orchestration | 🚧 | Added deterministic provider registry (`openai`/`anthropic`/`heuristic`) and provider-aware decision metadata; external LLM execution pending |
