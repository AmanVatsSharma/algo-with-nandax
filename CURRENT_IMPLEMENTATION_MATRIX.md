...
| Fill reconciliation from tradebook | 🚧 | Added on-demand `/trades/reconcile` + minute-level grouped orderbook snapshot reconciliation + partial-fill rollup metadata persistence; true streaming tradebook sync pending |
